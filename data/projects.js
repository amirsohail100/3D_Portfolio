const categoryMeta = {
  ml: {
    ...
    names: ["Rainfall Prediction System", "Flipkart Product Sentiment & Rating Predictor", "New York City Airbnb ML Analytics Web App", "Telehealth AI", "Mental Health Signal", "SMS Spam Detection", "Market & Economic Predictor App", "Stroke Prediction System", "Air Passengers Prediction System", "Credit Fraud Detection"],
  ...
  web: {
    ...
    names: ["WebGL Experience Portal", "Motion Commerce Shell", "Immersive SaaS Dashboard", "Creative Portfolio Engine", "Cinematic Brand Platform", "Experience Commerce Layer", "Realtime Product Storyboard", "Future Interface Studio", "Interactive Launch System", "Glassmorphism Command Center", "Virtual Product Showcase", "Design System Playground", "Immersive Leaderboard", "Storytelling Commerce Suite", "Interactive Journey Engine", "Next-Gen Product Launch"],
