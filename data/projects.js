const categoryMeta = {
  ...
  web: {
    ...
    names: ["TIC TAC TOE", "Todo List App", "Weather App", "ROCK PAPER SCISSORS", "TaskFlow", "Memory Game", "Expensive Management", "Future Interface Studio", "Currency Converter", "Catch the Square!", "Calculator App", "CodeFlow Live", "Discord Server Invitation Card", "Storytelling Commerce Suite", "Amazon clone", "Flipkart clone"],
