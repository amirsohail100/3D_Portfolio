const categoryMeta = {
  ...
  web: {
    ...
    names: ["TIC TAC TOE", "Todo List App", "Immersive SaaS Dashboard", "ROCK PAPER SCISSORS", "TaskFlow", "Memory Game", "Expensive Management", "Future Interface Studio", "Currency Converter", "Catch the Square!", "Calculator App", "CodeFlow Live", "Immersive Leaderboard", "Storytelling Commerce Suite", "Interactive Journey Engine", "Next-Gen Product Launch"],
