const categoryMeta = {
  ...
  web: {
    ...
    names: ["TIC TAC TOE", "Todo List App", "Immersive SaaS Dashboard", "ROCK PAPER SCISSORS", "TaskFlow", "Memory Game", "Expensive Management", "Future Interface Studio", "Currency Converter", "Glassmorphism Command Center", "Virtual Product Showcase", "Design System Playground", "Immersive Leaderboard", "Storytelling Commerce Suite", "Interactive Journey Engine", "Next-Gen Product Launch"],
