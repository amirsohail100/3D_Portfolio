const categoryMeta = {
  ml: {
    ...
    names: ["Predictive Intelligence Hub", "Signal Forecast Studio", "Automation Risk Engine", "Customer Lifetime Optimizer", "Medical Pattern Atlas", "Demand Intelligence Grid", "Fraud Detection Lens", "Behavioral Recommender Core", "Computer Vision QA Lab", "Insight Flow Platform"],
